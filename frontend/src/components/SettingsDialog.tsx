...
export function SettingsDialog({ open, onOpenChange, connections: initialConnections, onUpdateConnections, defaultTab = 'general', onDefaultTabChange }: SettingsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl h-[90vh] sm:h-[85vh] flex flex-col w-[95vw] sm:w-full p-0 shadow-2xl">
          ...
          <div className="flex-1 overflow-y-auto px-4 sm:px-6">
            ...
            <div className="p-4 rounded-lg bg-gradient-to-r from-violet-50 to-indigo-50 dark:from-violet-950/30 dark:to-indigo-950/30 border border-violet-200 dark:border-violet-800">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-violet-500 via-purple-500 to-pink-500 flex items-center justify-center text-white">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="flex items-center gap-2 p-2 rounded bg-background/50">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{connections.length} {connections.length === 1 ? 'database' : 'databases'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 p-2 rounded bg-background/50">
            ...
            <div className="space-y-2">
              <Label>Manage Database Connections</Label>
              <p className="text-muted-foreground">
                Add, edit, or remove your database connection strings
              </p>
              {connections.length === 0 && (
                <div className="p-4 rounded-lg bg-muted/50 border border-border">
                  <p className="text-muted-foreground text-center">
                    No database connections yet. Add your first connection below.
                  </p>
                </div>
              )}
            </div>
