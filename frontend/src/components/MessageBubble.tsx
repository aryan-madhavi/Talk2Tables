        ...
        <div className="flex gap-3 group max-w-[85%] sm:max-w-[70%]">
          <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              <div className="bg-gradient-to-r from-violet-600 to-indigo-600 rounded-2xl rounded-tr-sm px-4 py-3 shadow-lg">
                <p className="break-words leading-relaxed text-white">{message.content}</p>
              </div>
              {/* Hover Actions */}
              {/* <div className="absolute -top-3 left-4 hidden group-hover:flex items-center gap-1 bg-card border border-border rounded-lg shadow-xl p-1">
  ...
  return (
    <div className="flex gap-3 group max-w-[85%] sm:max-w-[70%]">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="relative">
          <div className="bg-muted rounded-2xl rounded-tl-sm px-4 py-3 shadow-lg hover:shadow-xl transition-shadow">
            <p className="break-words leading-relaxed">{message.content}</p>
          </div>
          {/* Hover Actions */}
          {/* <div className="absolute -top-3 right-4 hidden group-hover:flex items-center gap-1 bg-card border border-border rounded-lg shadow-xl p-1">
            <Button variant="ghost" size="icon" className="h-7 w-7">
              <Smile className="h-4 w-4" />
            </Button>
            <Button variant="ghost" size="icon" className="h-7 w-7">
